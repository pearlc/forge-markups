...
(function() {
    ...
    CKEDITOR.plugins.add( 'myimage', {
		...
		init: function( editor ) {
			var pluginName = 'myimage';

			// Register the dialog.
			CKEDITOR.dialog.add( pluginName, this.path + 'dialogs/myimage.js' );
			...
			editor.ui.addButton && editor.ui.addButton( 'myimage', {
			...
			if ( editor.addMenuItems ) {
				editor.addMenuItems({
					myimage: {
						label: editor.lang.myimage.menu,
						command: 'myimage',
						group: 'myimage'
					}
				});
