...
(function() {
    var imageDialog = function( editor, dialogType ) {
        ...
        return {
            title: editor.lang.myimage[ dialogType == 'image' ? 'title' : 'titleButton' ],
            minWidth: 420,
            minHeight: 360,
            onShow: function() {
...
//                    this.preview.setStyle( 'display', 'none' );
            ...
            onOk: function() {
                ...
                if ( this.imageEditMode ) {
                    ...
                    if ( dialogType == 'image' && imgTagName == 'input' && confirm( editor.lang.myimage.button2Img ) ) {
                        // Replace INPUT-> IMG
                        imgTagName = 'img';
                        this.imageElement = editor.document.createElement( 'img' );
                    ...
                    else if ( dialogType != 'image' && imgTagName == 'img' && confirm( editor.lang.myimage.img2Button ) ) {
                        // Replace IMG -> INPUT
                        imgTagName = 'input';
            ...
            contents: [
                {
                    id: 'info',
                    label: editor.lang.myimage.infoTab,
                    accessKey: 'I',
                    elements: [
                        {
                            type: 'file',
                        ...
                        },
                        {
                            ...
                            label: editor.lang.myimage.btnUpload,
                            'for': [ 'info', 'upload' ]
                        },
                        {
                            type: 'vbox',
...
//                                                    dialog.preview.setStyle( 'display', 'none' );
                                            ...
                                            validate: CKEDITOR.dialog.validate.notEmpty( editor.lang.myimage.urlMissing )
                                        },
                                        {
                                            type: 'button',
                                            id: 'browse',
